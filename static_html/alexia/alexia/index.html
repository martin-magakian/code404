						...
						<div class="collapse navbar-collapse justify-content-center col-md-8" id="navbarNav12">
						  <ul class="navbar-nav justify-content-right">
							<li class="nav-item active">
							  <a class="nav-link" href="https://www.froala.com">cursus</a>
							</li>
							<li class="nav-item">
							  <a class="nav-link" href="https://www.froala.com">success story</a>
							</li>
							<li class="nav-item">
							  <a class="nav-link" href="https://www.froala.com">à propos</a>
							</li>
							<li class="nav-item">
...
<div class="container partie2">
	...
	<a href="#"><button type="button" class="btn btn-danger">Prêt à démarrer l'aventure ?</button></a>	
</div>
...
<div class="container">
    <div class="row">
        <div class="col content-align-bottom-1 macenter" >
        ...
        <div class="col" >
            <p class="content-align-bottom-2 macenter">L'école supérieur de développement informatique <br/>© 2017 - Tous droits réservés</p>
        </div>
        <div class="col col content-align-bottom-1 align-right" >
